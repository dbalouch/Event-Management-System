                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Jatoi Private Dining Room</h1><!--location title-->
                            <p class="location"><!--location secondary content-->
                            Jatoi Private Dining Room, Pakistan Chowk Larkana 
                            </p>
                            <p class="definition"><!--content body-->
                            The Jatoi Private Dining Room, located in Pakistan Chowk Larkana, offers an exclusive and intimate space for hosting events and gatherings. Whether you're planning a birthday celebration, a corporate meeting, a wedding reception, or any special occasion, our private dining room provides a secluded and elegant setting for your event needs. With customizable packages and attentive service, we ensure a memorable and seamless experience for you and your guests at the Jatoi Private Dining Room.
                            </p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Shahzeb Birthday Hall</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Shahzeb Birthday Hall</h1><!--location title-->
                            <p class="location">Shahzeb Birthday Hall, Sachal Calony Larkana</p><!--location secondary content-->
                            <p class="definition">
                            Shahzeb Birthday Hall, located in Sachal Colony, Larkana, is the ideal venue for celebrating birthdays and special occasions. Our spacious hall offers a welcoming atmosphere, making it perfect for hosting memorable events.
                            </p>
                            <hr class="customline3"><!--css modified horizontal line--> 
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Lashari Event Management & Col</h1>
                            <p class="location">Lashari Event Management & Co, Sachal Calony Larkana.</p>
                            <p class="definition">Lashari Event Management & Co, located in Sachal Colony, Larkana, is your trusted partner in creating seamless and unforgettable events. Whether it's a wedding, corporate gathering, or any special occasion, our experienced team is dedicated to delivering tailored event solutions that exceed your expectations, ensuring a memorable and stress-free experience for you and your guests.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Collage Event</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                college events, our versatile event spaces are designed to accommodate various needs, whether it's a formal gathering, a casual get-together, or anything in between. Our dedicated event team is here to support you in planning and executing successful college events of any scale.
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Collage Events</h1>
                            <p class="location">Lashari Event Management & Co, Sachal Calony Larkana.e</p>
                            <p class="definition"> college events, our versatile event spaces are designed to accommodate various needs, whether it's a formal gathering, a casual get-together, or anything in between. Our dedicated event team is here to support you in planning and executing successful college events of any scale.</p>
                            <hr class="customline3">   
